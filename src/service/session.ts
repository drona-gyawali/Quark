  ...
  try {
    ...
    if (error) {
      throw new SuperBaseException(
        `Error Occured while creating session: ${error}`,
      );
    }
    return data;
  } catch (err: unknown) {
    throw new SuperBaseException(
      `Error Occured while creating session: ${err}`,
    );
  }
};
...
export const getSession = async (userId: string) => {
  try {
    ...
    if (error) {
      throw new SuperBaseException(
        `Error Occured while fetching session: ${error}`,
      );
    }
    return data;
  } catch (err: unknown) {
    throw new SuperBaseException(
      `Error Occured while fetching session: ${err}`,
    );
  }
};
...
export const deleteSession = async (session_id: string) => {
  try {
    ...
    if (error) {
      throw new SuperBaseException(
        `Error Occured while deleting session: ${error}`,
      );
    }
    return data;
  } catch (error: unknown) {
...
export const updateSession = async (session_id: string, label: string) => {
  try {
    ...
    if (error) {
      throw new SuperBaseException(
        `Error Occured while updating session: ${error}`,
      );
    }
